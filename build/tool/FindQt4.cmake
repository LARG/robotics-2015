...
IF (QT_QMAKE_EXECUTABLE AND QTVERSION)
  ...
  IF (NOT (QT_QTCORE_LIBRARY_RELEASE OR QT_QTCORE_LIBRARY_DEBUG)  OR QT_QMAKE_CHANGED)
    ...
    FIND_LIBRARY(QT_QTCORE_LIBRARY_RELEASE
                 NAMES QtCore QtCore${QT_LIBINFIX} QtCore${QT_LIBINFIX}4
                 HINTS ${QT_LIBRARY_DIR_TMP}
                 NO_DEFAULT_PATH
        )
    # Need to set this manually because naoqi breaks FIND_LIBRARY
    SET(QT_QTCORE_LIBRARY_RELEASE ${QT_LIBRARY_DIR}/libQtCore.so.4)
  ...
  SET(QT_HEADERS_DIR ${NAOQI_INCLUDES}/qt4)
  SET(QT_QTCORE_INCLUDE_DIR ${QT_HEADERS_DIR}/QtCore)
  IF(0) # skip this to avoid naoqi issues
  IF (QT_LIBRARY_DIR AND (NOT QT_QTCORE_INCLUDE_DIR OR NOT QT_HEADERS_DIR OR  QT_QMAKE_CHANGED))
    ...
    MESSAGE(FATAL_ERROR "what the heck headers: ${QT_QTCORE_INCLUDE_DIR}")
  ...
  FOREACH(QT_MODULE ${QT_MODULES})
    ...
    # Need to set this manually because naoqi breaks FIND_LIBRARY
    SET(QT_${_upper_qt_module}_LIBRARY_RELEASE ${QT_LIBRARY_DIR}/lib${QT_MODULE}.so.4)
