#include "WalkEnginePreProcessor.hpp" // Removed motion/generator - Josiah
...
#define FORWARD_THRESHOLD 37.5//25
#define LEFT_THRESHOLD 37.5//20
...
bool WalkEnginePreProcessor::isLinedUp() {return linedUp;}
