...
const float FIELD_Y = 6030;
const float FIELD_X = 9000;
const float GRASS_Y = 7330;
const float GRASS_X = FIELD_X + 2 * 700;
...
const float GOAL_POST_WIDTH = 100;
