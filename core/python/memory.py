...
def init():
  ...
  __blocks__ = [
    "behavior_mem", "camera_block", "game_state", "kick_request", "odometry", "robot_state", "sensors", \
    "vision_frame_info", "walk_param", "kick_params", "walk_request", "walk_response", "world_objects", "team_packets", "opponent_mem", \
    "behavior_params", "joint_commands", "processed_sonar", "al_walk_param", "walk_info", "robot_vision", "body_model", \
    "robot_info", "speech", "localization_mem", "image", \
