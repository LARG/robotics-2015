#!/usr/bin/env python
import core, mem_objects
from core import DEG_T_RAD, RAD_T_DEG
import time, math, copy
import UTdebug

from memory import vision_frame_info, sensors, team_packets, \
  odometry, robot_state, walk_request, world_objects, robot_state, \
  game_state, behavior_mem
...
def copyToCppArray(dest=None,src=None,method=None):
