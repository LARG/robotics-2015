...
def runCommand(command,password=None,output=True):
...
def runLocalCommand(command,password=None,output=None):
  command = command.replace("'", "'\"'\"'")
  return runCommand(command,password,output=output)

def runRemoteCommand(ip,command,root=False,output=None):
  command = command.replace("'", "'\"'\"'")
  if root:
